...
<html>
    ...
    <link rel="stylesheet" href="<?php echo e(URL::asset('css/w3.css')); ?>">
    ...
    <!--<script src="<?php echo e(URL::asset('js/jquery-latest.js')); ?>"></script>-->
    <script src="<?php echo e(URL::asset('js/jquery-3.2.1.min.js')); ?>"></script>
    <!--<script src="<?php echo e(URL::asset('js/jquery-migrate-1.4.1.min.js')); ?>"></script>-->
    <!--<script src="<?php echo e(URL::asset('js/jquery-migrate-3.0.0.min.js')); ?>"></script>-->
    ...
    <!-- Scripts propios -->
    <script src="<?php echo e(URL::asset('js/spin.min.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('js/scripts.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('js/ajaxCalls.js')); ?>"></script>
    <script src="<?php echo e(URL::asset('js/callbackFunctions.js')); ?>"></script>
    <!--<script src="<?php echo e(URL::asset('js/ContextMenu.js')); ?>"></script>-->
    ...
    <body onload="initializeApplication()">
        ...
        <nav class="w3-sidebar w3-bar-block w3-collapse w3-white w3-animate-left w3-card-2" 
            ...
            <div class="w3-bar-item w3-border-bottom w3-large w3-center">
                <img src="<?php echo e(URL::asset('images/logoSALTA.JPG')); ?>" style="width:50%;" 
            ...
            <div id="divComoLLegoForm" class="w3-show w3-animate-left">
                <div class="w3-container">
                    <?php echo $__env->make('components/comollego_form_w3', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                </div>
        ...
        <div class="w3-main" style="margin-left:320px;">
            ...
            <!--<div class="person">-->
            <div id="map" style="position: static"><?php echo $__env->make('components/map', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?></div>
